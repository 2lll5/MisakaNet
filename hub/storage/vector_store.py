"""Semantic embedding helpers (generate_embedding + model singleton).

The VectorStore class was removed 2026-08-31 — dead code per vulture+dead
audit (no callers); only the embedding function used by the search engine
remains.
"""
